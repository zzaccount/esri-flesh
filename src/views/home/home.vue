    ...
    <dv-border-box1>
      ...
      >
              ...
              <div class="box">
                <div class="top1">
                  <div class="top-about">
                    <div class="top-about-left">
                      <i
                        class="iconfont icon-eryanghuatannongdu"
                        style="font-size: 27px"
                      ></i>
                    </div>
              ...
              <div class="box">
                <div class="top1">
                  <div class="top-about">
                    <div class="top-about-left">
                      <i
                        class="iconfont icon-jiangyuliang"
                        style="font-size: 27px"
                      ></i>
                    </div>
        ...
        <div class="right">
          ...
          <homePanel class="panel" title="通知与公告">
            <div>
              <dv-scroll-board
                :config="Lunboconfig"
...
export default {
  ...
  setup() {
    ...
    const Lunboconfig = reactive({
      ...
      headerBGC: "rgb(12,16,20)",
      oddRowBGC: "rgb(12,16,20)",
      evenRowBGC: "rgb(33,37,45)",
      index: false,
      columnWidth: [50],
      align: ["center"],
    });
  ...
  mounted() {
    ...
    var option;
    /* 折线图 */
    var chartDom = document.getElementById("guosxx");
    var myChart = echarts.init(chartDom);
    /* 柱状图 */
    var device = document.getElementById("device-bar");
    console.log(device);
